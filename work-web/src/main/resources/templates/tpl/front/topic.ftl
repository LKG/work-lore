            ...
            <div class="panel panel-default hot-article" id="hot-article" style="box-shadow: 0 2px 8px 0 rgba(0,0,0,0.1);">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-3 hot-list">
                            <div class="thumbnail">
                                <a href="#" target="_blank" alt="纪检人必备监督执纪规则流程">
                                    <img src="https://static.gongwk.com/images/2019051301.jpg" alt="纪检人必备监督执纪规则流程">
                                </a>
                                <div class="caption">
                                    <h4><a href="/index.php?s=/Home/Hot/goods/id/1.html" target="_blank" alt="纪检人必备监督执纪规则流程">纪检人必备监督执纪规则流程</a></h4>
                                    <p><a href="/index.php?s=/Home/Hot/goods/id/1.html" target="_blank" alt="详解监督执纪规则流程，初核、谈话、函询、立案、审理、问题线索处置超详细流程图，纪检人必备。">详解监督执纪规则流程，初核、谈话、函询、立案、审理、问题线索处置超详细流程图，纪检人必备。</a></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 hot-list">
                            <div class="thumbnail">
                                ...
                                <div class="caption">
                                    <h4><a href="/index.php?s=/Home/Hot/goods/id/2.html" target="_blank" alt="案件检查工作流程全套模板">案件检查工作流程全套模板</a></h4>
                                    <p><a href="/index.php?s=/Home/Hot/goods/id/2.html" target="_blank" alt="案件检查工作流程全套模板">案件检查工作流程全套模板</a></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 hot-list">
                            <div class="thumbnail">
                                <a href="#" target="_blank" alt="初核工作流程记录全套模板">
                                    <img src="https://static.gongwk.com/images/2019051303.jpg" alt="初核工作流程记录全套模板">
                                </a>
                                <div class="caption">
                                    <h4><a href="/index.php?s=/Home/Hot/goods/id/3.html" target="_blank" alt="2019两会专区">初核工作流程记录全套模板</a></h4>
                                    <p><a href="/index.php?s=/Home/Hot/goods/id/3.html" target="_blank" alt="2019两会专区">2初核工作流程记录全套模板</a></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 hot-list">
                            <div class="thumbnail">
                                <a href="#" target="_blank" alt="信访举报工作流程全套模板">
                                    <img src="https://static.gongwk.com/images/2019051304.jpg" alt="信访举报工作流程全套模板">
                                </a>
                                <div class="caption">
                                    <h4><a href="/index.php?s=/Home/Hot/goods/id/4.html" target="_blank" alt="党建文秘素材">信访举报工作流程全套模板</a></h4>
                                    <p><a href="/index.php?s=/Home/Hot/goods/id/4.html" target="_blank" alt="党建文秘素材">信访举报工作流程全套模板</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
