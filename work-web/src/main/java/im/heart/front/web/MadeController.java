 ...
 */
@Controller
public class MadeController extends AbstractController {
	 ...
	 * @return
	 */
	@RequestMapping(value={"/made",apiVer+"/made"}  ,method = RequestMethod.GET)
	public ModelAndView made(HttpServletRequest request, HttpServletResponse response,
		...
		return new ModelAndView("front/made");
	}
