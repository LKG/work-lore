...
public class FrameRoleResourceServiceImpl extends CommonServiceImpl<FrameRoleResource, BigInteger> implements FrameRoleResourceService {
	...
	public List<FrameRoleResource> findByRoleCodes(String... roleCodes) {
		List<FrameRoleResource> roleResources=this.frameRoleResourceRepository.findByRoleCodeIn(roleCodes);
		return roleResources;
	}
	@Override
	...
	public List<FrameRoleResource> findByRoleIds(BigInteger... roleIds) {
		List<FrameRoleResource> roleResources=this.frameRoleResourceRepository.findByRoleIdIn(roleIds);
		return roleResources;
	}
	...
	public List<FrameRoleResource> saveRoleResource(FrameRole role, List<ResourceCheckModel> checkBoxModels) {
		...
		return this.frameRoleResourceRepository.saveAll(entities);
	}
