 ...
 */
@Repository
public interface PeriodicalRepository extends QuerydslPredicateExecutor<Periodical>,  JpaRepository<Periodical, BigInteger> ,JpaSpecificationExecutor<Periodical> {
	...
	@Modifying
	@Transactional(rollbackOn = Exception.class)
	@Query("UPDATE Periodical model SET downTimes=downTimes+1 WHERE model.id = :id")
	public void updateDownTimesById(@Param("id") BigInteger id);
