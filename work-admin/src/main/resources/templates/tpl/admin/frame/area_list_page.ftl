	   ...
	   <form class="form-search form-inline" id="search_form" >  
	    ...
	    <input type="hidden" name="size" id="size" value="" v-model="size"  />
           <div class="form-group">
               ...
               <input type="text" class="form-control"  value='' id="code" name="code_LIKES" placeholder="名称">
           </div>
	     <div class="form-group">
			 <label for="name" >名称:</label>
			 <input type="text" class="form-control"  value='' id="name" name="name_LIKES" placeholder="名称">
		 </div>
		 <div class="form-group">
		 ...
		 <table class="table table-bordered table-condensed table-hover">
	        <thead>
	          <tr>
			   ...
			   <th  class="page-sort-btn" data-sort="code" >代号
	           	 <i class="fa "  ></i>
	            </th>
