<form class="form-horizontal"  style="padding:5px 15px;"  action="" id="J_MainForm"  method="post"  >
    ...
    <div class="form-group" id="dictValue-div" >
        ...
        <div class="col-xs-10">
            <textarea class="form-control" id="dictValue" name="dictValue" placeholder="值" rows="3">${result.dictValue!''}</textarea>
        </div>
    </div>
	</#if>
    <div class="form-group">
        ...
        <div class="col-xs-10">
           <textarea class="form-control" id="dictDesc" name="dictDesc" placeholder="描述" rows="3">${result.dictDesc!''}</textarea>
        </div>
    </div>
    <div class="form-group">
