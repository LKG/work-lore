...
<body class="page-header-fixed">
	...
	<div class="full-container" id="main-container" style="height: 531px;">
		...
		<form class="form-horizontal" id="J_RegisterForm"  action="${appHost}/admin/user/save" method="post" >
		  ...
		  <div class="form-group">
		     <label for="userPhone" class="col-sm-1 col-xs-1 control-label"><b class="text-danger" >*</b><@spring.message  code="label.user.phone" /></label>
		    <div class="col-sm-9 col-xs-9">
			    <div class="input-group ">
		  ...
		  <!--
		  <div class="form-group">
		     <label for="password" class="col-sm-1 col-xs-1 control-label"><span class="text-danger" >*</span><@spring.message  code="label.login.password" /></label>
		    <div class="col-sm-9 col-xs-9">
			    <div class="input-group">
		   ...
		   <div class="form-group">
		     <label for="retryPassWord" class="col-sm-1 col-xs-1 control-label"><span class="text-danger" >*</span><@spring.message  code="label.user.password.confirm" /></label>
		    <div class="col-sm-9 col-xs-9">
			    <div class="input-group">
			      <div class="input-group-addon"><i class="fa fa-key"></i></div>
		 ...
		 <!----  
		  <div class="form-group">
		     <label for="phoneCode" class="col-sm-1 col-xs-1 control-label"><span class="text-danger" >*</span>短信码：</label>
		    <div class="col-sm-9 col-xs-9">
			    <div class="input-group">
